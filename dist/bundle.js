...
},{"../package.json":10,"universal-user-agent":29}],3:[function(require,module,exports){
...
},{"./util/add-query-parameters":6,"./util/extract-url-variable-names":7,"./util/omit":9,"url-template":30}],6:[function(require,module,exports){
...
},{"./lib/with-defaults":15,"./package.json":16,"@octokit/request":17,"universal-user-agent":29}],13:[function(require,module,exports){
...
},{"./lib/with-defaults":22,"./package.json":23,"@octokit/endpoint":1,"universal-user-agent":29}],18:[function(require,module,exports){
...
let marketplaceRunButton = document.getElementById("marketplace-listings-run");

async function run() {
    marketplaceRunButton.disabled = true;

    let graphql = site.getGraphQL();

    let response = await graphql(`query lookupMarketplaceListings {
        marketplaceListings(first: 100, allStates: true) {
         nodes {
             slug
             url
             isApproved
    ...
    `);
    site.resultsReset();
    site.addResultColumns("Slug", "Approved", "Delisted", "Draft", "Rejected");
    for (let node of response.data.marketplaceListings.nodes) {
        site.addResultRow(
            node.url, [
                node.slug,
                node.isApproved,
    ...
    marketplaceRunButton.disabled = false;
}

marketplaceRunButton.addEventListener("click", run);
},{"./site":36}],33:[function(require,module,exports){
...
},{"./site":36,"moment":27}],35:[function(require,module,exports){
let moment = require("moment");
let site = require("./site");
...
},{"./site":36,"moment":27}],36:[function(require,module,exports){
...
},{"@octokit/graphql":12}],37:[function(require,module,exports){
let site = require("./site");
